...
// XML Processing
    public void unmarshall() {
        if (Options.GOALSXMLFILE.exists()) {
            try {
                ...
                Root.displayDialog_Information("Information", "Couldn't Open Current Goals XML File", "Check Read File Permissions Of " + Options.GOALSXMLFILE.getAbsolutePath());
            }
        }
    }
    public void marshall() {
        try {
            ...
            Root.displayDialog_Information("Information", "Couldn't Save Current Goals XML File", "Check Write File Permissions Of " + Options.GOALSXMLFILE.getAbsolutePath());
        }
    }
    // Add
