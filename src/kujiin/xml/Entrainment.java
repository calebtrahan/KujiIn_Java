...
public class Entrainment {
    ...
    private List<SoundFile> rampinfiles;
    private List<SoundFile> rampoutfiles;
    @XmlTransient
...
// Information Methods
    ...
    public void calculateshortfreqduration() {
        MediaPlayer mediaPlayer = new MediaPlayer(new Media(freqshort.getFile().toURI().toString()));
        mediaPlayer.setOnReady(() -> {
            freqshort.setDuration(mediaPlayer.getTotalDuration().toMillis());
            mediaPlayer.dispose();
        });
    }
    public void calculatelongfreqduration() {
        MediaPlayer mediaPlayer = new MediaPlayer(new Media(freqlong.getFile().toURI().toString()));
        mediaPlayer.setOnReady(() -> {
            freqlong.setDuration(mediaPlayer.getTotalDuration().toMillis());
            mediaPlayer.dispose();
        });
    }
