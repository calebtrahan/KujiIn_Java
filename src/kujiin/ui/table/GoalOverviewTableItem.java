...
public class GoalOverviewTableItem {
    ...
    public GoalOverviewTableItem(String sessionitem, String practicedtime, String currentgoal, String percentcompleted, String goalscompleted) {
